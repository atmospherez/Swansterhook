...
local function LoadScript() 
 local script = Instance.new('LocalScript', Load)
	script.Parent.MouseButton1Click:Connect(function()
		loadstring(game:HttpGet("https://raw.githubusercontent.com/atmospherez/Swansterhook/main/swansterhook.lua"))()
		wait(0.1)
		GUI.loader:Destroy()
...
local function AnimateScript()
 local script = Instance.new('LocalScript', title)
	while true do
		...
		wait(0.5)
		script.Parent.Text = "sw" 
		wait(0.5)
		script.Parent.Text = "swa" 
		wait(0.5)
		script.Parent.Text = "swan" 
		wait(0.5)
		script.Parent.Text = "swans" 
		wait(0.5)
		script.Parent.Text = "swanst" 
		wait(0.5)
		script.Parent.Text = "swanster" 
		wait(0.5)
		script.Parent.Text = "swansterh" 
		wait(0.5)
		script.Parent.Text = "swansterho" 
		wait(0.5)
		script.Parent.Text = "swansterhoo" 
		wait(0.5)
		script.Parent.Text = "swansterhook" 
		wait(0.5)
		script.Parent.Text = "swansterhoo" 
		wait(0.5)
		script.Parent.Text = "swansterho" 
