	...
	Title = "swansterhook"; -- 
	Text = "Thank you for Using swansterhook!"; -- 
	Duration = 7; -- 
	})
    ...
    library:CreateWatermark("swansterhook | pasted | BUILD: dev")
	...
	local cfglocation = "swanstercfg/"      
	makefolder("swanstercfg")      
	...
	local MainUIColor = COL3RGB(255, 189, 222)    

	--I see those pastes laying around...
	--Credits to Rainy.solutions for the Watermark, MexicanHook for Show Team Damage GUI and making the Custom Pitch, LunarSense for Most AA's, Neptunium.cc for Resolver and Better Prediction/
	--Check them out!
	...
	do 
		...
		TextLabel.BorderColor3 = Color3.fromRGB(255, 189, 222)
		TextLabel.Position = UDim2.new(0, 1, 0.300000012, 0)
		TextLabel.Size = UDim2.new(0, 200, 0, 20)
		TextLabel.ZIndex = 3
		TextLabel.Font = Enum.Font.Code
		TextLabel.Text = "keybinds"
		TextLabel.TextColor3 = Color3.fromRGB(255, 189, 222)
	...
	function keybindadd(text)
		...
		TextLabel.Text = name 
		TextLabel.TextColor3 = COL3RGB(255, 189, 222) 
		TextLabel.TextSize = 15.000 
		TextLabel.TextXAlignment = Enum.TextXAlignment.Left 

		TabButtons.Name = "TabButtons" 
		TabButtons.Parent = Menu 
		TabButtons.BackgroundColor3 = COL3RGB(	) 
		...
		function menu:Tab(text) 
			...
			TabGui.Name = "TabGui" 
			TabGui.Parent = Tabs 
			TabGui.BackgroundColor3 = COL3RGB(255, 189, 222) 
			...
			Left.Name = "Left" 
			Left.Parent = TabGui 
			Left.BackgroundColor3 = COL3RGB(255, 189, 222) 
			...
			Right.Name = "Right" 
			Right.Parent = TabGui 
			Right.BackgroundColor3 = COL3RGB(255, 189, 222) 
	...
	local gui = library:New("swansterhook")      
	...
	antiaim:Element("Dropdown", "pitch", {options = {"None", "Up", "Down","Huge", "Custom", "Zero", "180", "Random AA", "Swindler", "God", "Sus_down", "wtf", "glitch", "sussy", "fucker"}})   
	...
	RunService.RenderStepped:Connect(function(step)     
		...
		if PlayerIsAlive then      
								...
								if Client.gun:FindFirstChild("Melee") and values.rage.aimbot["knifebot"].Toggle then      
									...
									for _,Hitbox in ipairs(Hitboxes) do      
										...
										if values.rage.aimbot["automatic penetration"].Toggle then      
											...
											local Penetration = Client.gun.Penetration.Value * 0.8      
			...
			if values.rage.angles.enabled.Toggle and not DisableAA then      
				...
				local Pitch = values.rage.angles["pitch"].Dropdown == "Sus_down" and -3 or values.rage.angles["pitch"].Dropdown == "None" and CamLook.Y or values.rage.angles["pitch"].Dropdown == "Swindler" and -129433 or values.rage.angles["pitch"].Dropdown == "Up" and 1 or values.rage.angles["pitch"].Dropdown == "Down" and -1.3 or values.rage.angles["pitch"].Dropdown == "Zero" and 0 or values.rage.angles["pitch"].Dropdown == "Random AA" and RANDOM(-1362, 2337)/5078 or values.rage.angles["pitch"].Dropdown == "Huge" and math.huge or values.rage.angles["pitch"].Dropdown == "Custom" and values.rage.angles["pitch angle"].Slider or 2.5 or values.rage.angles["pitch"].Dropdown == "wtf" and 99999999999999999999999999999999999999999999999999999999 or values.rage.angles["pitch"].Dropdown == "glitch" and (0 + -5) or values.rage.angles["pitch"].Dropdown == "God" and 15 or values.rage.angles["pitch"].Dropdown == "fucker" and -13 or values.rage.angles["pitch"].Dropdown == "sussy" and math.huge -1/0 -5  
	...
	LocalPlayer.Status.Kills:GetPropertyChangedSignal("Value"):Connect(function(current)      
		...
		if values.misc.chat["kill say"].Toggle then      
			game:GetService("ReplicatedStorage").Events.PlayerChatted:FireServer(values.misc.chat["message"].Text ~= "Super Idol" and values.misc.chat["message"].Text or "The smile of Super Idol is not as sweet as yours. The sun at noon in August is not as dazzling as you. I love you at 105 °C. Drops of pure distilled water", false, "Innocent", false, true)      
		end      
	end)      
	...
	ChatScript.createNewMessage("swansterhook","swansterhook is Successfully 100% Loaded",MainUIColor,Color3.new(1,1,1),0.01,nil)
	ChatScript.moveOldMessages()
	ChatScript.createNewMessage("swansterhook","Thank you for Using swansterhook :D",MainUIColor,Color3.new(1,1,1),0.01,nil)
	ChatScript.moveOldMessages()
	ChatScript.createNewMessage("swansterhook","Version Indev",MainUIColor,Color3.new(1,1,1),0.01,nil)
	ChatScript.moveOldMessages()
	ChatScript.createNewMessage("swansterhook","Credits to Rainy.solution, Mexican Hook, LunarSense, Neptunium.cc, For Giving me Permissions :D",MainUIColor,Color3.new(1,1,1),0.01,nil)